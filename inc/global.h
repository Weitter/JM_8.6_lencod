...
typedef struct
{
  ...
  int mb_x;                    //!< current MB horizontal 以图像左上角为原点 得到当前宏块mb左上角的16*16坐标
  int mb_y;                    //!< current MB vertical
  int block_x;                 //!< current block horizontal 以图像左上角为原点 得到当前宏块mb左上角的4*4坐标
  int block_y;                 //!< current block vertical
  int pix_x;                   //!< current pixel horizontal  以图像左上角为原点 得到当前宏块mb左上角的像素坐标
